...
namespace GameFW.Nav
{
    public class GeoEdge2D
    {
        ...
        {
            return MathTool.Abs(Vector2.Angle(a.Vec, b.Vec) % 180f) < 1e-06;
        }
        ...
        public static bool IsOnline(Vector2 point, GeoEdge2D edge)
        {
            ...
            return MathTool.Abs(Vector2.Distance(point, pointA) + Vector2.Distance(point, pointB) - Vector2.Distance(pointA, pointB)) < 1e-06;
        }
